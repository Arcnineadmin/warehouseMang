...
export default function LoginForm() {
  ...
  return (
    <>
      <Card
        isBlurred
        className="min-w-unit-lg border-none bg-background/60 p-10 dark:bg-default-100/50"
        shadow="sm"
      >
        <form onSubmit={handleSubmit}>
          <CardHeader className="flex items-start justify-center p-9">
            <h1 className="text-2xl">🔐 Hello, please log in.</h1>
          </CardHeader>
          <CardBody>
            <div className="mb-4">
              <Input
